...
def train(
    ...
    if start_epoch > 0:
        ...
        model_path = os.path.join(
            model_dir, "checkpoints", "model_epoch_%04d.pth" % start_epoch
        )
        ...
        logpath = os.path.join(
            model_dir, "checkpoints", "train_losses_epoch_%04d.txt" % start_epoch
        )
    #     with open(logpath) as f:
    #         reader = csv.reader(f)
    #         train_losses = list(reader)
    # else:
    # else:
    ...
    np.savetxt(
        os.path.join(checkpoints_dir, "train_losses_final.txt"), np.array(train_losses)
    )
